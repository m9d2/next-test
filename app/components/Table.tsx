...
const Table = (props: TableProps) => {
    ...
    const {data, isLoading, isValidating, mutate} = useFetch<Response>([props.url, params, pagination], {
        url: props.url,
        method: props.method,
        params: {...params, ...props.params, ...pagination, page: pagination.page - 1},
    })
    ...
    return <>
        <ProTable loading={isLoading && isValidating}
                  cardBordered
